...
| 2026-09-20 | The stale-entry search test failed on first run. The engine was right: with A→G costing 1 the goal was popped before the beaten A entry ever came up, so there was nothing stale to see. | Fixed the fixture (A→G costs 10), not the engine. | 6b1a5a3 |
