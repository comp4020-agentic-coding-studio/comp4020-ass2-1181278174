...
import { designCase } from "./design-case.ts";
...
const all: CaseDef<any>[] = [edgesCase, searchCase, labelsCase, timetableCase, assignCase, padsCase, corridorCase, priorityCase, levelsCase, replayCase, designCase];
